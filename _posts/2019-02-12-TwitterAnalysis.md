...
จากการวิเคราะห์ข้อมูลจาก Twitter รวมทั้งสิ้นจำนวน 2,002,446 tweet ที่รวบรวมโดยการใช้ search/tweets API ระหว่างวันที่ 7-9 กุมภาพันธ์ (07.00 น.)เมื่อประมวลผลผ่านการนับจำนวน tweet ต่อนาที ของ tweet ที่มี hashtag เกี่ยวข้องโดยตรงกับเหตุการณ์ในวันที่ 8 กุมภาพันธ์ จะเห็นได้ถึงความสอดคล้องกับสถานการณ์ทางการเมืองที่เกิดขึ้น
...
## เพิ่มเติม
นอกจากการประเมินสถานการณ์โดยดูจากจำนวน tweet เป็นหลักแล้ว เราสามารถที่จะใช้ text analysis เพื่อ tokenize ประโยคคำใน tweet เพื่อวิเคราะห์ให้ละเอียดยิ่งขึ้น อาจได้ measurement ที่น่าสนใจอื่นๆ เช่น คำยอดฮิต ชื่อนักการเมืองยอดนิยม หรือคำที่มักปรากฎอยู่ในบริบทเดียวกัน อีกทั้งยังสามารถใช้ unsupervised learning methods ต่างๆ เช่น LDA (latent dirichlet allocation) หรือ STM (structural topic modeling) เพื่อทำการวิเคราะห์ประเด็นต่างๆ ที่ได้รับความสนใจ และทัศนคติทางการเมืองที่ได้รับการแสดงออกผ่าน Twitter สุดท้ายคือการทำ sentiment analysis เพื่อหยั่งรู้ถึงอารมณ์และความรู้สึกที่ผู้ใช้ Twitter มีต่อเหตุการณ์ครั้งนี้ โปรดติดตามชมตอนต่อไปครับ

## Coding
ดู code ที่ใช้ใน project นี้ได้ <a href= "https://github.com/naponjatusripitak/twitter_thai">ที่นี่</a> หรือลองอ่านดูได้ดังต่อไปนี้
