...
## คำยอดนิยม
สิ่งที่ทำได้เป็นอันดับแรกเมื่อทำการตัดคำไทยเป็นที่เรียบร้อยแล้ว คือการคำนวนสถิติการใช้คำแต่ละคำ โดยปกติแล้วมีสองวิธีหลักๆในการวิเคราะห์ วิธีแรกคือนับมันไปเลย คำไหนใช้บ่อยที่สุดคือคำที่เป็นที่นิยมมากที่สุด วิธีที่สองคือวิธีที่เรียกกันว่า tf-idf (term frequency-inverse document frequency) ซึ่งเป็นการนับสถิติของการใช้คำในแต่ละข้อความ (ยิ่งใช้บ่อยยิ่งมีค่าสูงขึ้น) ที่มีการถ่วงดุลโดยจำนวนข้อความที่ใช้คำๆนี้ (ยิ่งคำนี้ปรากฎในหลายข้อความยิ่งมีค่าต่ำลง) เพื่อเป็นการคัดกรองคำที่
